...
public class Calculator{
	...
	public Result add(@PathParam("value1") Double a,@PathParam("value2") Double b) {
	...
	@Produces(MediaType.APPLICATION_XML)
	public Result subtract(@PathParam("value1") Double a,@PathParam("value2") Double b) {
		Double ans;
	...
	public Result factorial(@PathParam("value1") Double a) {
		...
		Result result = new Result("Factorial");
	        ...
	        //factorialStreams is more efficient but cannot handle factorials of numbers greater than 21
	        if(a<=1) {
	        	result.setOutput("1");
	        }if(a<20) {
